...
public class PieColumarServerGraph extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		this.requestWindowFeature(Window.FEATURE_NO_TITLE);
			...
			values = new float[] { 1.0f,1.0f, 1.0f, 0.0f ,3.0f , 5.0f ,1.0f };
			values1 = new float[] { 3.0f, 5.0f, 2.0f, 4.0f , 3.0f , 5.0f ,2.0f };
		    ...
		    DrawView myView = new DrawView( PieColumarServerGraph.this,values, values1,
...
@Override
    ...
    public void onBackPressed() {
        ...
        Intent setIntent = new Intent(PieColumarServerGraph.this, Kisai_BT_Main.class);
