...
public class PieColumarClientGraph extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		this.requestWindowFeature(Window.FEATURE_NO_TITLE);
		    ...
		    DrawView myView = new DrawView( PieColumarClientGraph.this,values, values1,
...
@Override
    ...
    public void onBackPressed() {
        ...
        Intent setIntent = new Intent(PieColumarClientGraph.this, Kisai_BT_Main.class);
